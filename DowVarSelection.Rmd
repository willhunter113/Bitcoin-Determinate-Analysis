...
```{r}
DowPredictive <- subset(VarSelection, select = -c(Dow,ChangeDow, Bitcoin, SP500, ChangeSP500, Nasdaq,ChangeNasdaq,InterestRates, FederalFundsRate,X10YrTreasuryYield,Prices,EconomicPolicyUncertainty, X3YrTreasuryYield, disposable.Value, X30YrTreasuryYield, BusinessConditions, Unemployment))
```
